...
# Overrides
PRODUCT_NAME := visionsom_8mm 
PRODUCT_DEVICE := visionsom_8mm
PRODUCT_MODEL := VISIONSOM_8MM
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/visionsom_8mm/camera_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mm.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/visionsom_8mm/powerhint_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mm.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/visionsom_8mm/thermal_info_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mm.json
